...
It's been quite a week, launching our [design system](https://esign.ewu-web.de//blog/design-system), [kicking of a Malfunction Mania](https://esign.ewu-web.de//blog/malfunction-mania), a [shiny new contributor perk](https://esign.ewu-web.de//blog/shop) and our [early adopter deal](https://esign.ewu-web.de//blog/early-adopters). After discussing Version 1.0 a lot, we want to close the week by looking ahead. As an open company, we want transparency about what we are working on and what to expect next. Especially for our Early Adopters, we want to paint a clear picture of what to expect in the near term.
