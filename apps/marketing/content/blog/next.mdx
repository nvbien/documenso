...
Last week, Lucas shared the reasoning how [why we're doing a rewrite](https://esign.ewu-web.de//blog/why-were-doing-a-rewrite).
...
We recently [switched to Discord](https://esign.ewu-web.de//blog/switching-from-slack-to-discord) to set up a more developer-friendly, community-driven environment, and we just released the [public roadmap](https://documen.so/launches).
